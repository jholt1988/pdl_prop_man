...
const deleteVendorRequestHandlerOptions = {
    onValidateParams:idParameterValidator,
        ...
        onValidRequestAsync: async (req, details) => { 
            if (details && details.params) {
              ...
              await prismaClient.vendor.delete({where: {id: id}})
...
export const deleteVendorRequestHandler = restRequestBuilder(deleteVendorRequestHandlerOptions)