...
const Schema: z.ZodType<Prisma.TransactionUpdateManyWithoutLeaseNestedInput> = z
  .object({
    create: z
      .union([
...
export const TransactionUpdateManyWithoutLeaseNestedInputObjectSchema = Schema;
