...
const Schema: z.ZodType<Prisma.RepairRequestUpdateManyWithoutPropertyNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const RepairRequestUpdateManyWithoutPropertyNestedInputObjectSchema =
  Schema;
