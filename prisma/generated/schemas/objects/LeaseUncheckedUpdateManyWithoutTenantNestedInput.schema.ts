...
const Schema: z.ZodType<Prisma.LeaseUncheckedUpdateManyWithoutTenantNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => LeaseUpsertWithWhereUniqueWithoutTenantInputObjectSchema,
          ),
          z
            .lazy(
              () => LeaseUpsertWithWhereUniqueWithoutTenantInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => LeaseUpdateWithWhereUniqueWithoutTenantInputObjectSchema,
          ),
          z
            .lazy(
              () => LeaseUpdateWithWhereUniqueWithoutTenantInputObjectSchema,
...
export const LeaseUncheckedUpdateManyWithoutTenantNestedInputObjectSchema =
  Schema;
