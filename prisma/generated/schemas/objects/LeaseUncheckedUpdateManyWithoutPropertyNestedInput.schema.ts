...
const Schema: z.ZodType<Prisma.LeaseUncheckedUpdateManyWithoutPropertyNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => LeaseUpdateManyWithWhereWithoutPropertyInputObjectSchema,
          ),
          z
            .lazy(
              () => LeaseUpdateManyWithWhereWithoutPropertyInputObjectSchema,
...
export const LeaseUncheckedUpdateManyWithoutPropertyNestedInputObjectSchema =
  Schema;
