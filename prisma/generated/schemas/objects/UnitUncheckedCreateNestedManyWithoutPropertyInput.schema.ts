...
const Schema: z.ZodType<Prisma.UnitUncheckedCreateNestedManyWithoutPropertyInput> =
  z
    .object({
      create: z
        .union([
...
export const UnitUncheckedCreateNestedManyWithoutPropertyInputObjectSchema =
  Schema;
