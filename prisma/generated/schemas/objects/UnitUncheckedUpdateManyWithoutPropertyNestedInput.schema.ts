...
const Schema: z.ZodType<Prisma.UnitUncheckedUpdateManyWithoutPropertyNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => UnitUpsertWithWhereUniqueWithoutPropertyInputObjectSchema,
          ),
          z
            .lazy(
              () => UnitUpsertWithWhereUniqueWithoutPropertyInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => UnitUpdateWithWhereUniqueWithoutPropertyInputObjectSchema,
          ),
          z
            .lazy(
              () => UnitUpdateWithWhereUniqueWithoutPropertyInputObjectSchema,
...
export const UnitUncheckedUpdateManyWithoutPropertyNestedInputObjectSchema =
  Schema;
