...
const Schema: z.ZodType<Prisma.RepairRequestUncheckedCreateNestedManyWithoutVendorInput> =
  z
    .object({
      create: z
        .union([
...
export const RepairRequestUncheckedCreateNestedManyWithoutVendorInputObjectSchema =
  Schema;
