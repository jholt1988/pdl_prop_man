...
const Schema: z.ZodType<Prisma.RepairRequestUncheckedUpdateManyWithoutUnitNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const RepairRequestUncheckedUpdateManyWithoutUnitNestedInputObjectSchema =
  Schema;
