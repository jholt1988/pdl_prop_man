...
const Schema: z.ZodType<Prisma.RepairRequestUpdateManyWithWhereWithoutUnitInput> =
  z
    .object({
...
export const RepairRequestUpdateManyWithWhereWithoutUnitInputObjectSchema =
  Schema;
