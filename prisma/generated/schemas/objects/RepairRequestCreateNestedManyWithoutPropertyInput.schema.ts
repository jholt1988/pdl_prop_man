...
const Schema: z.ZodType<Prisma.RepairRequestCreateNestedManyWithoutPropertyInput> =
  z
    .object({
      create: z
        .union([
...
export const RepairRequestCreateNestedManyWithoutPropertyInputObjectSchema =
  Schema;
