...
const Schema: z.ZodType<Prisma.LeaseUncheckedCreateWithoutTransactionInput> = z
  .object({
...
export const LeaseUncheckedCreateWithoutTransactionInputObjectSchema = Schema;
