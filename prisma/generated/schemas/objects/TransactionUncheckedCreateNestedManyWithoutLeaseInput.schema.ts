...
const Schema: z.ZodType<Prisma.TransactionUncheckedCreateNestedManyWithoutLeaseInput> =
  z
    .object({
      create: z
        .union([
...
export const TransactionUncheckedCreateNestedManyWithoutLeaseInputObjectSchema =
  Schema;
