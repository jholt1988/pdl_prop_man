...
const Schema: z.ZodType<Prisma.LeaseUpdateManyWithoutUnitNestedInput> = z
  .object({
    create: z
      .union([
        ...
        z.lazy(() => LeaseUncheckedCreateWithoutUnitInputObjectSchema).array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => LeaseCreateOrConnectWithoutUnitInputObjectSchema),
        z.lazy(() => LeaseCreateOrConnectWithoutUnitInputObjectSchema).array(),
      ])
      .optional(),
    upsert: z
      .union([
...
export const LeaseUpdateManyWithoutUnitNestedInputObjectSchema = Schema;
