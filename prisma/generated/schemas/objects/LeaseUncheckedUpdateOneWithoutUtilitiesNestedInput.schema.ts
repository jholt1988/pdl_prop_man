...
const Schema: z.ZodType<Prisma.LeaseUncheckedUpdateOneWithoutUtilitiesNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const LeaseUncheckedUpdateOneWithoutUtilitiesNestedInputObjectSchema =
  Schema;
