...
const Schema: z.ZodType<Prisma.TransactionUncheckedUpdateManyWithoutTenantNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const TransactionUncheckedUpdateManyWithoutTenantNestedInputObjectSchema =
  Schema;
