...
const Schema: z.ZodType<Prisma.RepairRequestUncheckedUpdateManyWithoutVendorNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const RepairRequestUncheckedUpdateManyWithoutVendorNestedInputObjectSchema =
  Schema;
