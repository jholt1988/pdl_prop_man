...
const Schema: z.ZodType<Prisma.RepairRequestCreateNestedManyWithoutUnitInput> =
  z
    .object({
      create: z
        .union([
...
export const RepairRequestCreateNestedManyWithoutUnitInputObjectSchema = Schema;
