...
const Schema: z.ZodType<Prisma.TransactionCreateNestedManyWithoutTenantInput> =
  z
    .object({
      create: z
        .union([
...
export const TransactionCreateNestedManyWithoutTenantInputObjectSchema = Schema;
