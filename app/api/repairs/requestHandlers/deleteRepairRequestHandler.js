...
const deleteRepairRequestHandlerOptions = {
    ...
    onValidRequestAsync: async (req, details) => {
        if (details && details.params) {
            ...
            await prismaClient.repairRequest.delete({ where: { id: id } });
...
export const deleteRepairRequestHandler = restRequestBuilder(deleteRepairRequestHandlerOptions);
